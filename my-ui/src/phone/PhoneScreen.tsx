...
import { SkyFlappyApp } from './apps/SkyFlappyApp.tsx'
import { NeonDropApp } from './apps/NeonDropApp.tsx'
      ...
      <div className="phone-screen">
        {activeApp === 'home' ? (
          ...
          <>
            ...
            {activeApp === 'sky-flappy' && <SkyFlappyApp />}
            {activeApp === 'neon-drop' && <NeonDropApp />}
            {activeApp !== 'messages' &&
              activeApp !== 'contacts' &&
              activeApp !== 'phone' &&
              activeApp !== 'settings' &&
