...
const installed = new Set(['phone', 'messages', 'calculator', 'camera', 'clock', 'weather', 'banking', 'mail', 'notes', 'memos', 'photos', 'app-store', 'settings', 'map', 'music', 'garage', 'feather', 'calendar', 'health', 'citywarn', 'crypto', 'house', 'billing', 'darkchat', 'companies', 'crewlink', 'health', 'local-pages', 'weazel-news', 'flare', 'fliptok', 'picstagram', 'radio', 'calendar'])
